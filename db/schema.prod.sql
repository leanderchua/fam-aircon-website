-- FAM Airconditioning Supply CMS schema (Hostinger production)
-- Import this into the u311097277_fam_cms database via phpMyAdmin.
-- No CREATE DATABASE / USE statements — phpMyAdmin's direct link already
-- scopes the import to the correct (prefixed) database name.
